create table tb_customers (id bigserial not null, cpf varchar(255), email varchar(255) unique, image varchar(255), name varchar(255), password varchar(255), primary key (id));
